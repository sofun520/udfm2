...
<body>
	<div style="margin-bottom: 10px;">
		<a href="javascript:void(0);" class="sui-btn"><i
			class="sui-icon icon-pencil"></i>新增菜单</a>
		<button id="J_addsuppliers" data-toggle="modal"
			data-target="#J_addsuppliersDialog" data-width="large"
			data-backdrop="static" class="sui-btn btn-primary">新增菜单</button>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="sui-form form-horizontal sui-validate"
						novalidate="novalidate" action="add.do">
						...
						<div class="control-group">
							<label for="inputEmail" class="control-label">父菜单主键：</label>
							<div class="controls">
								<input type="text" id="inputEmail" name="mParent" placeholder=""
									data-rules="required">
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="inputEmail" name="mType" placeholder=""
									data-rules="required">
							</div>
						</div>
					</form>
				...
				<div class="modal-footer">
					<button type="button" data-ok="modal"
						class="sui-btn btn-primary btn-large">提交</button>
