...
<body>
	...
	<div class="center">
		...
		<div class="main_content">
			<div class="sui-content">
				<iframe id="subFrame" style="width: 100%;border: 0px;">
	...
	<script type="text/javascript">
		$(function() {
			$("#subFrame").css('height', document.documentElement.clientHeight-80);
			$(".left_menu").css('height', document.documentElement.clientHeight-70);
			getPMenu();
		});
		...
		function getSubMenu(id) {
			$.get("../api/menu/query.do?mType=1&mParent="+id,function(data){
				...
				$.each(data.data,function(i,value){
					...
					ht+='<li><a href="javascript:void(0)" onclick="loadFrame(\''+value.mUrl+'\')"><i class="sui-icon icon-tb-cascades"></i>'+value.mName+'</a></li>';					
				});
				$("#subMenu").html(ht);
				loadFrame(murl);
			});
